...
{{ img(style="height: 30em;", src="eighth-of-winter.jpg", alt="A black, white, and gold card depicting an elk skeleton with giant gold horns and trees around it. It is labeled, 'The Eighth of Winter'.")}}
...
{{ img(style="height: 30em;", src="ten-of-cups.png", alt="The ten of cups card in the Rider-Waite-Smith tarot, described below.")}}
...
{{ img(style="height: 30em;", src="ten-of-cups-chromatic.jpg", alt="A purple card with 10 wine glasses being raised in the air in a 'Cheers' gesture by 10 hands. It is labeled 'X of Cups'")}}
