...
{% include img.html style="height: 25em;" file="eighth-of-winter.jpg" alt="A black, white, and gold card depicting an elk skeleton with giant gold horns and trees around it. It is labeled, 'The Eighth of Winter'"%}
...
{% include img.html style="height: 25em;" file="ten-of-cups.png" alt="The ten of cups card in the Rider-Waite-Smith tarot, described below."%}
...
{% include img.html style="height: 25em;" file="ten-of-cups-chromatic.jpg" alt="A purple card with 10 wine glasses being raised in the air in a 'Cheers' gesture by 10 hands. It is labeled 'X of Cups'"%}
